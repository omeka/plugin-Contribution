...
2. Your public theme does not link to the Contribution page by default, so you will need to add a link somewhere on your public theme.  You can either add another entry to the nav() function call in the common/header.php file, which will put the link in your theme's upper navigation, or you can put the php function link_to_contribute('Text of My Link') somewhere in your theme.
