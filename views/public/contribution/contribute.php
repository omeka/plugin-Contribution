    ...
    <?php else: ?>
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <fieldset id="contribution-confirm-submit" <?php if (!isset($type)) { echo 'style="display: none;"'; }?>>
                ...
                <p><?php echo __("You must read and agree to the %s in order to contribute.",  "<a href='" . contribution_contribute_url('terms') . "' target='_blank'>" . __('Terms and Conditions') . ".</a>"); ?></p>
                <div class="inputs">
