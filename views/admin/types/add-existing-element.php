<li class="element">
    ...
    <div class="sortable-item drawer">
        ...
        <button type="button" class="delete-drawer" data-action-selector="deleted" title="<?php echo __('Remove %s', __('new element')); ?>" aria-label="<?php echo __('Remove %s', __('new element')); ?>"><span class="icon" aria-hidden="true"></button>
    </div>
